...
def upgrade():
    ...
    op.add_column('userprofile', sa.Column('template_id', postgresql.UUID(as_uuid=True), nullable=True))
...
def downgrade():
    ...
    op.add_column('user', sa.Column('template_id', postgresql.UUID(), autoincrement=False, nullable=True))
    op.create_foreign_key('user_template_id_fkey', 'user', 'template', ['template_id'], ['id'])
    # ### end Alembic commands ###
